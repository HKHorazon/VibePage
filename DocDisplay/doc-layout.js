      ...
      <div class="layout-body">
        <aside class="sidebar">
          <a :href="indexPath" class="sidebar-heading" @click="closeSidebar">
            ...
            <span class="sidebar-heading-text">KNOWLEDGE.INDEX</span>
